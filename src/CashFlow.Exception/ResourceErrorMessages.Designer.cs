...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string EXPANSE_CANNOT_BE_FOR_THE_FUTURE {
            get {
                return ResourceManager.GetString("EXPANSE_CANNOT_BE_FOR_THE_FUTURE", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Your password must be at least 8 characters long, containing at least one uppercase letter, one lowercase letter, one number and one special character (!, ?, * or .).
        /// </summary>
